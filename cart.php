...
while ($row = mysqli_fetch_array($result)) {
    ...
    $id = rtrim($id, ", ");
    echo "<tr><td></td><td>Total</td><td>Rp " . $sum . "</td><td><a href='success.php' class='btn btn-primary'>Confirm Order</a></td></tr>";
    ?>
                            </tbody>
                            <?php
} else {
    ...
    <div class='empty-cart'>
        <img src='images/kosong.png' class='img-fluid' height='150' width='150' alt='Empty Cart'>
        <br/>
        <div class='text-bold h5'>Oops! You haven't added anything to your cart.</div>
    </div>";
}
